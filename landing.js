       ...
       ' <!-- Brand and toggle get grouped for better mobile display -->'+
        '<div class="navbar-header">'+
          '<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#main-navbar" aria-controls="main-navbar" aria-expanded="false" aria-label="Toggle navigation">'+
            ...
            '<span class="lni-menu"></span>'+
          '</button>'+
          '<a href="index.php" class="navbar-brand"><img src="assets/img/logo-header2.png" alt="dokuwo"></a>'+
        '</div>'+
        ...
        '<div class="container">'+
          '<div class="row">'+
            '<div class="col-lg-3 col-md-3 col-xs-12">'+
              '<div class="widget">'+
                '<div class="footer-logo rotate-n-15"><img src="assets/img/logo-footer.png" class="rounded-circle" alt="dokuwo" style="width: 64px; height: 64px;"></div>'+
            ...
            '<div class="col-lg-3 col-md-4 col-xs-12">'+
              '<div class="widget">'+
                ...
                '<ul class="mt-3 footer-social">'+
                  ...
                  '<li><a class="instagram" href="https://www.instagram.com/dokuwo_gm/" target="_blank"><i class="lni-instagram"></i></a></li>'+
                '</ul> '+       
              '</div>'+
            '</div>'+
          '</div>'+
          ...
          <div class="panel panel-default">
              ...
              <div id="collapseOne" class="panel-collapse collapse in">
                <div class="panel-body">
                  ...
                  <br>
                  <p>
                     The solution is to use a different email server until.
                  </p>
                </div>
              </div>
            </div>
