...
function gotoHomepage(){
  ...
  document.cookie ="cookie_usertype =" + session_usertype + ";" + expires + ";path="+base_url+"index.php";
  document.cookie ="cookie_user_id =" + session_user_id + ";" + expires + ";path="+base_url+"index.php";
